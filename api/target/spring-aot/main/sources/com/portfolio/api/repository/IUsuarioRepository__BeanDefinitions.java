...
/**
 * Bean definitions for {@link IUsuarioRepository}
 */
public class IUsuarioRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'IUsuarioRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getIUsuarioRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'iUsuarioRepository'
   */
  public static BeanDefinition getIUsuarioRepositoryBeanDefinition() {
    ResolvableType beanType = ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, IUsuarioRepository.class, Object.class, Object.class);
